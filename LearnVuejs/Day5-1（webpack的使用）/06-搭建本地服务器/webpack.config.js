...
module.exports={
  ...
  output:{
    ...
    //当我们通过插件打包html后它就在dist文件夹下了和那些文件同级就
    // 不需要用这个再加前缀了
  ...
  // 搭建我们的本地服务器也需要修改我们的配置
  devServer:{
    // 我们要在这里面提供一些选项 它会根据这些选项来选择服务的是哪个文件夹
    // 就是我们的contentBase这个属性
    contentBase:'./dist',
    // 因为我们最终打包是往这里面打包的，所以需要服务的就是我们的dist文件夹
    inline:true
    // 表示是否需要实时的更新
  }
